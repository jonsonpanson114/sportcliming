...
import { MessageCircle, Play, ClipboardList, Zap, Send, Sparkles, RefreshCw, HelpCircle } from 'lucide-react';
...
export default function QAPage() {
  ...
  const handleAsk = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setError(data.error || '雉ｪ蝠上・騾∽ｿ｡縺ｫ螟ｱ謨励＠縺ｾ縺励◆');
      }
    } catch (e) {
  ...
  const exampleQuestions = [
    '繝繧､繝弱・繧ｳ繝・ｒ謨吶∴縺ｦ',
    '蛻晏ｿ・・′譛蛻昴↓隕壹∴繧九∋縺阪％縺ｨ縺ｯ・・,
    '繝輔Λ繝・げ縺ｮ菴ｿ縺・婿繧呈蕗縺医※',
    '繧ｪ繝悶じ繝吶・繧ｷ繝ｧ繝ｳ縺ｮ讌ｵ諢上・・・,
  ];
      ...
      <main className="max-w-2xl mx-auto px-6 py-8 space-y-8">
        <header className="space-y-2">
          <h2 className="text-2xl font-display font-bold text-white flex items-center gap-2">
            AI 繧ｳ繝ｼ繝√Φ繧ｰ <Sparkles className="text-primary w-5 h-5" />
          </h2>
          <p className="text-white/40 text-sm">逅・ｫ悶→邨碁ｨ薙↓蝓ｺ縺･縺・◆繧ｯ繝ｩ繧､繝溘Φ繧ｰ縺ｮ遏･諱ｵ</p>
        </header>
        ...
        <section>
          <div className="glass-card p-6 space-y-4">
            ...
            <textarea
              ...
              placeholder="萓・ 繝繧､繝弱・繧ｳ繝・ｒ謨吶∴縺ｦ"
                ...
                <div className="relative group">
                  ...
                  <div className="relative glass-card p-6 space-y-4 border-primary/20">
                    <div className="flex items-center gap-2">
                      ...
                      <h3 className="text-sm font-bold text-white/80">繧ｳ繝ｼ繝√・蛻・梵邨先棡</h3>
                    </div>
